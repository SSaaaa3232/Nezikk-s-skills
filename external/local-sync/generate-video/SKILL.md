...
|-------|----------|------------------|---------------------|----------|
| `openai/sora-2` | OpenAI | 4, 8, 12 seconds | 16:9, 9:16 | High-quality AI video generation |
| `openai/sora-2-pro` | OpenAI | 4, 8, 12 seconds | 16:9, 9:16 | Professional-grade video generation |
| `google/veo-3.1-generate-preview` | Google | 6, 8, 10 seconds | 16:9, 9:16 | Latest Google video AI (recommended) |
| `google/veo-3.1-fast-generate-preview` | Google | 6, 8, 10 seconds | 16:9, 9:16 | Fast video generation |
| `byteplus/seedance-1-0-pro` | BytePlus | 6, 8, 10 seconds | 16:9, 4:3, 1:1, 3:4, 9:16, 21:9 | Pro-quality with flexible ratios |
...
# Using OpenAI Sora with custom settings
...
- **OpenAI Sora 2**: Choose when you need cinematic quality and complex scene understanding. Sora excels at realistic physics, lighting, and temporal consistency. Use `openai/sora-2-pro` for highest quality production work.

- **BytePlus Seedance**: Ideal when you need flexible aspect ratios beyond 16:9 and 9:16. Supports square (1:1), portrait (3:4, 9:16), and ultra-wide (21:9) formats. Use `byteplus/seedance-1-0-lite` for faster iteration.
